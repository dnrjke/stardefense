...
const DEFAULT_MAPS: Record<string, MapInfo> = {
  ...
  map_3_1: {
    ...
    completed: false,
    isBoss: false,
    description: '마그네타의 강력한 자기장이 감지된다. 은신한 적을 찾아 제거하라.',
  },
  map_3_2: {
    id: 'map_3_2',
    name: 'Quasar Exclusion Zone',
    nameKo: '퀘이사 접근 금지구역',
    act: 3,
    order: 2,
    unlocked: false,
  ...
  map_3_3: {
    ...
    completed: false,
    isBoss: false,
    description: '중성자별 잔해 사이로 세 갈래 경로가 열린다. 모든 방향을 경계하라.',
  },
  map_3_b: {
    id: 'map_3_b',
    name: 'Event Horizon',
    ...
    completed: false,
    isBoss: true,
    description: '사건의 지평선 너머에서 최강의 적이 밀려온다. 최후의 방어선을 구축하라.',
  },
  map_4_1: {
    id: 'map_4_1',
    name: 'Black Hole Border',
    nameKo: '블랙홀 경계',
    act: 4,
    order: 1,
    unlocked: false,
    completed: false,
    isBoss: false,
    description: '블랙홀의 사건 지평선 근처. 시공간이 왜곡되는 극한의 전장.',
  },
  map_4_2: {
    id: 'map_4_2',
    ...
    completed: false,
    isBoss: false,
    description: '두 은하가 충돌하는 혼돈의 전장. 세 갈래 경로로 적이 밀려온다.',
  },
  map_4_3: {
    id: 'map_4_3',
    ...
    completed: false,
    isBoss: false,
    description: '끝없이 밀려오는 적을 얼마나 오래 버틸 수 있는가? 무한 웨이브 모드.',
  },
  map_4_b: {
    id: 'map_4_b',
